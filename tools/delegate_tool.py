...
def _build_top_level_description() -> str:
    ...
    return (
        ...
        "create a native Kanban/AFK task with kanban_create and retain its "
        "task ID. Cron is only for scheduling the intake; terminal background "
        "processes and generic delegation are not durable delivery executors. "
